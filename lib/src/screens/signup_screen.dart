              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Nouveau ici ? Créez un compte en quelques secondes",
                      style: AppStyle(
                        fontSize: 20,
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (value.length < 8) {
                            return "Le mot de passe doit être au moins 6 caractéres";
                          }
                          final regex = RegExp(
                            r'^(?=.*[A-Za-z])(?=.*\d)(?=.*[!@#\$%^&*(),.?":{}|<>]).{8,}$',
                          );
                          ...
                          if (!regex.hasMatch(value)) {
                            return "Le mot de passe passe doit contenir au moins 1 chiffre et 1 caractére specail";
                          }
